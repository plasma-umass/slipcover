...
plot:
	python3 benchmarks/benchmarks.py plot --os=Linux --python=3.10.5 --out benchmarks/cpython.png --speedup --title "Slipcover Coverage Speedup on CPython (higher is better)" --bar-labels
