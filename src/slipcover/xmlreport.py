...
class XmlReporter:
    ...
    def report(self, outfile: IO[str] | None = None) -> None:
        ...
        # Write header stuff. documentElement is always set: createDocument
        # was just called above with a non-None qualifiedName ("coverage").
    ...
    def xml_file(self, file_path: str, file_data: CoverageFile) -> None:
        ...
        if self.with_branches:
            class_branches = sum(t for t, _ in branch_stats.values())
